  ...
  <div class="background-container flex justify-center items-center flex-col">
    ...
    <div class="glass-effect p-8 rounded-lg shadow-md">
      ...
      <form @submit.prevent="submitForm">
        <div class="mb-4">
          <label for="firstName" class="block text-gray-700 font-bold mb-2">Date</label>
          <input type="text" id="firstName" v-model="firstName" placeholder="JJ/MM" class="w-full px-3 py-2 text-gray-500 border rounded-md focus:outline-none focus:border-blue-500">
        </div>
        <div class="mb-4">
          <label for="lastName" class="block text-gray-700 font-bold mb-2">Heure</label>
          <input type="text" id="lastName" v-model="lastName" placeholder="XX:XX" class="w-full px-3 py-2 text-gray-500 border rounded-md focus:outline-none focus:border-blue-500">
        </div>
